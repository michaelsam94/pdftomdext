...
def main() -> None:
    ...
    # MD badge
    put_rect(pixels, width, 270, 360, 120, 90, (30, 85, 190, 255))
    put_rect(pixels, width, 290, 385, 80, 8, (255, 255, 255, 255))
    put_rect(pixels, width, 290, 405, 64, 8, (255, 255, 255, 255))

    out = Path("pdftomdext-banner.png")
